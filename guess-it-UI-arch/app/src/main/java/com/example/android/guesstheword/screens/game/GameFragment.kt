...
//        viewModel.score.observe(this, Observer { score -> updateScoreText(score) })
//        viewModel.word.observe(this, Observer { word -> updateWordText(word) })
...
//        })
        ...
        viewModel.finishEvent.observe(this, Observer { finishEvent ->
            if(finishEvent){
                gameFinished()
            }
        })
